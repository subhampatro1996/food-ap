        ...
        <div className="col-sm-12 col-md-6 col-lg-4 ">
          ...
          >
            <div className="card-body d-flex flex-column">
              ...
              <Link to="/american"><button type="button" name="american" className="btn btn-sm btn-outline-secondary"
              >
                Check American
              </button></Link>
            </div>
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 ">
          ...
          >
            <div className="card-body d-flex flex-column">
              ...
              <Link to="/indian"><button type="button" name="american" className="btn btn-sm btn-outline-secondary"
              >
      Check Indian
              </button></Link>
            </div>
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 ">
          ...
          >
            <div className="card-body d-flex flex-column">
              ...
              <Link to="/chineese"><button type="button" name="american" className="btn btn-sm btn-outline-secondary"
              >
      Check Chinese
              </button></Link>
            </div>
...
export default Home;
{
  /* <div className="container" style={{ marginTop: "90px" , justifyContent:"center"}}>
      <h1>Welcome to TasteFood</h1>
      <div className="row d-flex-justify-content-center">
        <div className="col" style={{margin:"60px"}}>
          <div className="shadow card" style={{width: "18rem"}}>
            <img src="https://freepngimg.com/thumb/chocolate/7-2-chocolate-png-8-thumb.png" className="card-img-top" alt="..." />
        ...
        <div className="col" style={{margin:"60px", justifyContent:"space-around"}}>
          <div className="shadow card" style={{width: "18rem"}}>
            <img src="https://freepngimg.com/thumb/coffee/6-2-coffee-png-hd-thumb.png" className="card-img-top" alt="..." />
            <div className="card-body">
              <p className="card-text">
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
        ...
        <div className="col" style={{margin:"60px"}}>
          <div className="shadow card" style={{width: "18rem"}}>
            <img src="https://freepngimg.com/thumb/ice%20cream/3-ice-cream-png-image-thumb.png" className="card-img-top" alt="..." />
            <div className="card-body">
              <p className="card-text">
                Some quick example text to build on the card title and make up
                the bulk of the card's content.
