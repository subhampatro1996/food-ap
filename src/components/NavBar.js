...
const NavBar = (props) => {
  ...
  return (
    <div className="container fixed-top ">
      <nav className="navbar navbar-expand-lg" style={{backgroundColor:"#f7881f"}}>
        <div className="container-fluid d-flex justify-content-center ">
          <div className="col-sm-12 col-md-6 my-sm-3 my-md-0 p-2">
            <a className="navbar-brand" href="#">
              <Link to="/" style={{textDecoration:"none",fontSize:"2rem", fontWeight:"bold", color:"white"}}>Food App</Link>
            </a>
          </div>
            ...
            <div className="navbar-nav ">
              <form className="d-flex " role="search">
                ...
                <Link to="/cart"><i
                  ...
                  style={{ alignSelf: "center", fontSize: "1.5rem", color:"white" }}
                ></i></Link>
